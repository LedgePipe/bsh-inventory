...
export default function Header({ user, profile, onLogout }: HeaderProps) {
  ...
  return (
    <header className="bg-gradient-to-r from-orange-500 to-red-500 text-white p-4 shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div>
          <h1 className="text-xl md:text-2xl font-bold flex items-center gap-2">
            🍾 BSH Inventory
            <span className="text-sm font-normal opacity-80 hidden sm:inline">- I'm Helping!</span>
          </h1>
